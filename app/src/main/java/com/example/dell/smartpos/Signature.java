...
public class Signature extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //check language
        String lang = prefsettings.getString("Language", "");
        changeLang(lang);
...
//		PartnerLogoUtil.setImageToImageView(partnerlogoview,baseUrl,partnerlogo);
    ...
    public void changeLang(String lang){
        ...
        else if(lang.equalsIgnoreCase("Tran. Chinese")){
            myLocale = Locale.TRADITIONAL_CHINESE;
        }
        else if(lang.equalsIgnoreCase("Simp. Chinese")){
            myLocale = Locale.SIMPLIFIED_CHINESE;
        }
        else if(lang.equalsIgnoreCase("HK")){
            myLocale = new Locale("hk");
        }
