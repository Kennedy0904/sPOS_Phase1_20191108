...
import com.example.spos_sdk2.FDMS.FdmsApiFunction;
import com.example.spos_sdk2.FDMS.FdmsVariable;
            ...
            public void onClick(View v) {
                ...
                if (strAmount.equals("") || MerchantRef.getText().toString().equals("")) {
                    ...
                    if (paymentOption.equalsIgnoreCase("SCAN QR PAYMENT")) {
                        ...
                        FdmsVariable.setMerId(getIntent().getStringExtra(Constants.MERID));
...
//                        FdmsVariable.setRemark(remark.getText().toString());
                        ...
                        FdmsVariable.setPayBankId("First-Data");
                        FdmsVariable.setTerminalId("00001332");

                        FdmsApiFunction fdmsRequest = new FdmsApiFunction(EnterAmount.this);
