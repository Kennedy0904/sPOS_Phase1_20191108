...
public class RequestRefundReportAdapter extends ArrayAdapter<Record> {
    ...
    RequestRefundReportInterface refundInterface;

    public RequestRefundReportAdapter(Context context, int layoutResourceId, ArrayList<Record> data, String merName, RequestRefundReportInterface refundInterface) {
...
//        }
        ...
        refundInterface.setRequestRefundTransactions(refund,
                ALIPAYHKOFFLRefund,
                ALIPAYCNOFFLRefund,
                ALIPAYOFFLRefund,
                BOOSTOFFLRefund,
