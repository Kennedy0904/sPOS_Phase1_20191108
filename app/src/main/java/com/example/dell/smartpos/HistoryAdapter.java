...
//        }
        ...
        /*if (record.payMethod.equalsIgnoreCase("WECHATONL")) {
            holder.txtPayMethod.setText(record.payMethod);
        } else if (record.payMethod.equalsIgnoreCase("WECHATOFFL")) {
            holder.txtPayMethod.setText(R.string.print_payMethod_wechatOffline);
        } else if (record.payMethod.equalsIgnoreCase("ALIPAYOFFL")) {
            holder.txtPayMethod.setText(R.string.print_payMethod_alipayOffline);
        } else if (record.payMethod.equalsIgnoreCase("ALIPAYCNOFFL")) {
            holder.txtPayMethod.setText(R.string.print_payMethod_alipayOffline);
        } else if (record.payMethod.equalsIgnoreCase("ALIPAYHKOFFL")) {
            holder.txtPayMethod.setText(R.string.print_payMethod_alipayHKOffline);
        } else if (record.payMethod.equalsIgnoreCase("ALIPAYHKONL")) {
            holder.txtPayMethod.setText(R.string.print_payMethod_alipayHKOnline);
        } else {
            holder.txtPayMethod.setText("");
        }*/
