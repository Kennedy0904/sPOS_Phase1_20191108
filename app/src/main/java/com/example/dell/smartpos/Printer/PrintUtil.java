...
public class PrintUtil {
    ...
    public void sendTransactionReport(){
        ...
        if(deviceMan.equalsIgnoreCase("SUNMI")){
            this.printService.printTransactionReport(context, info, product,
                    ALIPAYCNOFFLRecordsArray,
            ...
            this.printServicePAX.sendTransactionReportPAX(context, info, product,
                    ALIPAYCNOFFLRecordsArray,
                    ALIPAYHKOFFLRecordsArray,
                    ALIPAYOFFLRecordsArray,
                    BOOSTOFFLRecordsArray,
            ...
            if (lang.equalsIgnoreCase(Constants.LANG_THAI)) {
                this.printServiceThaiK9.printTransactionReport(context, info, product,
                        ALIPAYCNOFFLRecordsArray,
                        ALIPAYHKOFFLRecordsArray,
                        ALIPAYOFFLRecordsArray,
                        BOOSTOFFLRecordsArray,
                ...
                this.printServiceK9.printTransactionReport(context, info, product,
                        ALIPAYCNOFFLRecordsArray,
                        ALIPAYHKOFFLRecordsArray,
                        ALIPAYOFFLRecordsArray,
                        BOOSTOFFLRecordsArray,
    ...
    public void sendRefundReport(){
        ...
        if(deviceMan.equalsIgnoreCase("SUNMI")){
            System.out.println("Enter SUNMI printRefundReport");
            this.printService.printRefundReport(context,info,product,
                    ALIPAYHKOFFLRecordsArray,
                    ALIPAYCNOFFLRecordsArray,
                    ALIPAYOFFLRecordsArray,
                    BOOSTOFFLRecordsArray,
            ...
            this.printServicePAX.sendRefundReportPAX(context, info, product,
                    ALIPAYCNOFFLRecordsArray,
                    ALIPAYHKOFFLRecordsArray,
                    ALIPAYOFFLRecordsArray,
                    BOOSTOFFLRecordsArray,
            ...
            if (lang.equalsIgnoreCase(Constants.LANG_THAI)) {
                this.printServiceThaiK9.printRefundReport(context,info,product,
                        ALIPAYHKOFFLRecordsArray,
                        ALIPAYCNOFFLRecordsArray,
                        ALIPAYOFFLRecordsArray,
                        BOOSTOFFLRecordsArray,
                ...
                this.printServiceK9.printRefundReport(context,info,product,
                        ALIPAYHKOFFLRecordsArray,
                        ALIPAYCNOFFLRecordsArray,
                        ALIPAYOFFLRecordsArray,
                        BOOSTOFFLRecordsArray,
    ...
    public void sendVoidReport(){
        initView();

        if(deviceMan.equalsIgnoreCase("SUNMI")){
            this.printService.printVoidReport(context,info,product,
                    ALIPAYCNOFFLRecordsArray,
                    ALIPAYHKOFFLRecordsArray,
                    ALIPAYOFFLRecordsArray,
                    BOOSTOFFLRecordsArray,
            ...
            this.printServicePAX.sendVoidReportPAX(context,info,product,
                    ALIPAYCNOFFLRecordsArray,
                    ALIPAYHKOFFLRecordsArray,
                    ALIPAYOFFLRecordsArray,
                    BOOSTOFFLRecordsArray,
            ...
            if (lang.equalsIgnoreCase(Constants.LANG_THAI))
            {
                this.printServiceThaiK9.printVoidReport(context,info,product,
                        ALIPAYCNOFFLRecordsArray,
                        ALIPAYHKOFFLRecordsArray,
                        ALIPAYOFFLRecordsArray,
                        BOOSTOFFLRecordsArray,
                ...
                this.printServiceK9.printVoidReport(context,info,product,
                        ALIPAYCNOFFLRecordsArray,
                        ALIPAYHKOFFLRecordsArray,
                        ALIPAYOFFLRecordsArray,
                        BOOSTOFFLRecordsArray,
    ...
    public void sendRequestRefundReport(){
        initView();
