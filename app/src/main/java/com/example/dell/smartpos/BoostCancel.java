...
public class BoostCancel extends AsyncTask<String, Void, String> {
    ...
    public BoostCancel(PresentQRPayment_3 activity, ProgressDialog progressDialog, String PayGate) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        NameValuePair cardHolderNVPair = new BasicNameValuePair("cardHolder", "BOOSTOFFL");
        ...
        NameValuePair requestNVPair = new BasicNameValuePair("boostRequest", "cancel");
        ...
        try {
            System.out.println("---KJ do in background BoostCancel: enter payCompMPOS:");
            ...
            Log.d("1234","-----" + "manualQuery:" + PayGate.getQuery(nameValuePairs));
            writer.flush();
            writer.close();
            os.close();
    ...
    protected void onPostExecute(String s) {
        System.out.println("---KJ BoostCancel: onPostExecute");
        map = PayGate.splitOctopus(result);
        ...
        System.out.println("--KJ-prc: " + prc + " src:" + src + " " + successcode);
