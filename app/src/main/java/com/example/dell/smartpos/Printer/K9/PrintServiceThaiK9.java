...
//            printTwoColumnWithCharSpacing(info.get("TransactionDate"), product.get("TransactionDate"), 5);
            ...
            // Trx No
            printTwoColumnNoAlign(info.get("CardNo"), product.get("CardNo"));
//            printTwoColumnWithCharSpacing(info.get("CardNo"), product.get("CardNo"), 30);
...
//            printText(label.get("ToDateLabel") + "                   " +  value.get("ToDateLabel"));
        ...
        try{
            ...
            if (!value.get("TotalTrxALIPAYCNOFFL").equals("0")) {
                ...
                for (Record record : ALIPAYCNOFFLRecordsArray) {
                    ...
                    printTwoColumnNoAlign(label.get("QRNumber"), qr);
                    printDashLine();
                }
            }
    ...
    public void printRefundReport(Context context, Map<String, String> label, Map<String, String> value,
        ...
        try {
            ...
            if (value.get("TotalRefundALIPAYCNOFFL").equals("0")
                    ...
                    && value.get("TotalRefundWECHATHKOFFL").equals("0")
            ...
            if (!value.get("TotalRefundALIPAYCNOFFL").equals("0")) {
                printTextCenter(label.get("ALIPAYCNOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundALIPAYCNOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntALIPAYCNOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalRefundALIPAYHKOFFL").equals("0")) {
                printTextCenter(label.get("ALIPAYHKOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundALIPAYHKOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntALIPAYHKOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalRefundALIPAYOFFL").equals("0")) {
                printTextCenter(label.get("ALIPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundALIPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntALIPAYOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalRefundBOOSTOFFL").equals("0")) {
                printTextCenter(label.get("BOOSTOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundBOOSTOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntBOOSTOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalRefundGCASHOFFL").equals("0")) {
                printTextCenter(label.get("GCASHOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundGCASHOFFL"));

                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntGCASHOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalRefundGRABPAYOFFL").equals("0")) {
                printTextCenter(label.get("GRABPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundGRABPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntGRABPAYOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalRefundMASTER").equals("0")) {
                printTextCenter(label.get("MASTER"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundMASTER"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntMASTER"));
                printDashLine();
            ...
            if (!value.get("TotalRefundOEPAYOFFL").equals("0")) {
                printTextCenter(label.get("OEPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundOEPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntOEPAYOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalRefundPROMPTPAYOFFL").equals("0")) {
                printTextCenter(label.get("PROMPTPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundPROMPTPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntPROMPTPAYOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalRefundUNIONPAYOFFL").equals("0")) {
                printTextCenter(label.get("UNIONPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundUNIONPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntUNIONPAYOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalRefundVISA").equals("0")) {
                printTextCenter(label.get("VISA"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundVISA"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntVISA"));
                printDashLine();
            ...
            if (!value.get("TotalRefundWECHATOFFL").equals("0")) {
                printTextCenter(label.get("WECHATOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundWECHATOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntWECHATOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalRefundWECHATHKOFFL").equals("0")) {
                printTextCenter(label.get("WECHATHKOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundWECHATHKOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntWECHATHKOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalRefundWECHATONL").equals("0")) {
                printTextCenter(label.get("WECHATONL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalRefundWECHATONL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("RefundAmntWECHATONL"));
                printDashLine();
    ...
    public void printVoidReport(Context context, Map<String, String> label, Map<String, String> value,
                                ArrayList<Record> ALIPAYCNOFFLRecordsArray,
                                ArrayList<Record> ALIPAYHKOFFLRecordsArray,
                                ArrayList<Record> ALIPAYOFFLRecordsArray,
                                ArrayList<Record> BOOSTOFFLRecordsArray,
        ...
        try {
            ...
            if (value.get("TotalVoidALIPAYCNOFFL").equals("0")
                    ...
                    && value.get("TotalVoidGCASHOFFL").equals("0")
            ...
            if (!value.get("TotalVoidALIPAYCNOFFL").equals("0")) {
                printTextCenter(label.get("ALIPAYCNOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidALIPAYCNOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntALIPAYCNOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalVoidALIPAYHKOFFL").equals("0")) {
                printTextCenter(label.get("ALIPAYHKOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidALIPAYHKOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntALIPAYHKOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalVoidALIPAYOFFL").equals("0")) {
                printTextCenter(label.get("ALIPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidALIPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntALIPAYOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalVoidBOOSTOFFL").equals("0")) {
                printTextCenter(label.get("BOOSTOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidBOOSTOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntBOOSTOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalVoidGCASHOFFL").equals("0")) {
                printTextCenter(label.get("GCASHOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidGCASHOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntGCASHOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalVoidMASTER").equals("0")) {
                printTextCenter(label.get("MASTER"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidMASTER"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntMASTER"));
                printDashLine();
            ...
            if (!value.get("TotalVoidPROMPTPAYOFFL").equals("0")) {
                printTextCenter(label.get("PROMPTPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidPROMPTPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntPROMPTPAYOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalVoidUNIONPAYOFFL").equals("0")) {
                printTextCenter(label.get("UNIONPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidUNIONPAYOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntUNIONPAYOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalVoidVISA").equals("0")) {
                printTextCenter(label.get("VISA"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidVISA"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntVISA"));
                printDashLine();
            ...
            if (!value.get("TotalVoidWECHATHKOFFL").equals("0")) {
                printTextCenter(label.get("WECHATHKOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidWECHATHKOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntWECHATHKOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalVoidWECHATOFFL").equals("0")) {
                printTextCenter(label.get("WECHATOFFL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidWECHATOFFL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntWECHATOFFL"));
                printDashLine();
            ...
            if (!value.get("TotalVoidWECHATONL").equals("0")) {
                printTextCenter(label.get("WECHATONL"));
                printTwoColumnNoAlign(label.get("TotalTrxLabel"), value.get("TotalVoidWECHATONL"));
                printTwoColumnNoAlign(label.get("TotalAmntLabel"), value.get("currCode") + " " + value.get("VoidAmntWECHATONL"));
                printDashLine();
