		...
		if (this.isConnection) {
			...
			try {
				...
				if (lang.equalsIgnoreCase(Constants.LANG_THAI)) {
					printTwoColumn(info.get("PaymentType"), "");
					printLine();
					printTwoColumn(product.get("PayType"), "");
					printLine();
				...
				// Payment Method
				if (lang.equalsIgnoreCase(Constants.LANG_THAI)) {
					printTwoColumn(info.get("PayMethod"), "");
					printLine();
					printTwoColumn(product.get("PayMethod"), "");
					printLine();
				} else {
				...
				// Trx Date
				if (lang.equalsIgnoreCase(Constants.LANG_THAI)) {
					printTwoColumn(info.get("TransactionDate"), "");
					printLine();
					printTwoColumn(product.get("TransactionDate"), "");
					printLine();
				} else {
				...
				// Trx No
				if (product.get("CardNo").length() > 25 || lang.equalsIgnoreCase(Constants.LANG_THAI)) {
