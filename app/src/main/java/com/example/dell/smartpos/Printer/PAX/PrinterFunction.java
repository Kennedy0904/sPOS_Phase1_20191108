...
public class PrinterFunction extends BaseTester {

    private static PrinterFunction printerTester;
    ...
    public static PrinterFunction getInstance() {
        if (printerTester == null) {
            printerTester = new PrinterFunction();
        }
