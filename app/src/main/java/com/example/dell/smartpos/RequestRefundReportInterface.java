...
public interface RequestRefundReportInterface {
    public void setRequestRefundTransactions(TreeMap<String, String> report, ArrayList<Record> ALIPAYHKOFFLrecords,
